...
import cv2
import numpy as np
from yoloserver.utils.beautify import custom_plot # 确保 custom_plot 可以被访问
...
def process_frame(
    ...
    if project_args.beautify:
        ...
        annotated_frame = custom_plot(
            ...
            label_mapping=beautify_params.get("label_mapping", None),
            color_mapping=beautify_params.get("color_mapping", None),
        )
    else:

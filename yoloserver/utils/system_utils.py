...
try:
    ...
    pass  # pynvml 不可用，_PYNVML_AVAILABLE 保持为 False
...
def get_device_info():
    ...
    if cuda_available:
        ...
        # 显式声明 all_gpus_detail 是一个字符串到字符串字典的列表
        all_gpus_detail: List[Dict[str, str]] = []
        ...
        for i in range(gpu_count):
            try:
                ...
                gpu_detail = {
                    ...
                    f"GPU_{i}_多处理器数量": str(props.multi_processor_count),
